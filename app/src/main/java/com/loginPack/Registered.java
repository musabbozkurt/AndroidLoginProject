...
public class Registered extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        final TextView association = (TextView)findViewById(R.id.uname);
        final TextView phoneNumber = (TextView)findViewById(R.id.pnum);
        final TextView email = (TextView)findViewById(R.id.email);
        final TextView created_at = (TextView)findViewById(R.id.regat);
        fname.setText(user.get("fname"));
        lname.setText(user.get("lname"));
        association.setText(user.get("association"));
