...
public class DatabaseHandler extends SQLiteOpenHelper {
     ...
     * */
    public void addUser(String fname, String lname, String email, String association,String phoneNumber, String uid, String created_at) {
        ...
        values.put(KEY_ASSOCIATION, association); // UserName
    ...
    public HashMap<String, String> getUserDetails(){
        ...
        if(cursor.getCount() > 0){
            ...
            user.put("association", cursor.getString(4));
